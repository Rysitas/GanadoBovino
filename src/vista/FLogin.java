...
public class FLogin extends javax.swing.JFrame {
   ...
   Login login= new Login();
    ...
    Icon icono = new ImageIcon(getClass().getResource("/Imagenes/LogoAdmin.png"));
    Icon icono1 = new ImageIcon(getClass().getResource("/Imagenes/LogoUser.png"));
    
  
        if (login.validarIngreso() == 1) {
        
        if(txtUsuario.getText().equals("ADMINISTRADOR") || txtUsuario.getText().equals("administrador") ){
            this.dispose();
            JOptionPane.showMessageDialog(null, "Bienvenido " + txtUsuario.getText() + "\n"
                    + "Ha ingresado exitosamente a la guarida del Malvado Doctor Tocino :v", "Mensaje de Bienvenida",
            ...
            formulario.setVisible(true);
              ...
              this.dispose();
            JOptionPane.showMessageDialog(null, "Bienvenido " + txtUsuario.getText() + "\n"
                    + "Ha ingresado exitosamente a la guarida de Pyggie :v", "Mensaje de Bienvenida",
            ...
            JOptionPane.showMessageDialog(null, "Acceso Denegado\n"
                    + "Usuario y/o Contraseña incorrecto", "Acceso Denegado",
